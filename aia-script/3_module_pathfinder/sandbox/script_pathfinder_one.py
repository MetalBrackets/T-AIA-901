...
# Access the CSV file
file_path = os.path.join(os.path.dirname(__file__), '..', '..', '..', 'aia-data', 'gares-de-voyageurs.csv')
# file_path = os.path.join(os.path.dirname(__file__), '..', '..', '..', 'aia-data', 'liste-des-gares.csv')
